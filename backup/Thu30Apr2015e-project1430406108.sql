...
CREATE TABLE `kebutuhan_sdm` (
  ...
  CONSTRAINT `kebutuhan_sdm_ibfk_2` FOREIGN KEY (`kode_kebutuhan`) REFERENCES `team` (`sdm`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `pelaksanaan_proses_proyek` (
  ...
  CONSTRAINT `pelaksanaan_proses_proyek_ibfk_3` FOREIGN KEY (`material`) REFERENCES `kebutuhan_material` (`kode_material`),
  CONSTRAINT `pelaksanaan_proses_proyek_ibfk_4` FOREIGN KEY (`progress`) REFERENCES `progress` (`kode_progress`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO pengguna VALUES("PG150400008","Ronal","ronalasdasdasdasd","7","ronal@gmail.com","2147483647","1994-04-04","Bandung","L");
...
INSERT INTO proyek VALUES("PRO150400001","Perbaikan Jalan Muara Angke","Isi Deskripsi Disini","PG150400001","02/22/2015","04/02/2015","Menunggu","150000000","KL150400002","3");
INSERT INTO proyek VALUES("PRO150400002","Pembangunan Jaringan Instalasi gedung ","Isi Deskripsi disini","PG150400002","04/30/2015","05/09/2015","Menunggu","150000000","KL150400002","4");
...
CREATE TABLE `team` (
  ...
  KEY `sdm` (`sdm`),
  CONSTRAINT `team_ibfk_1` FOREIGN KEY (`kode_team`) REFERENCES `pelaksanaan_proses_proyek` (`team`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
